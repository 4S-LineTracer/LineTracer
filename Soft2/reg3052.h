/* port address of internal registers  for int32*/

#define DVICR 	(*(volatile unsigned char *)0xffff5d)

#define ASWCR 	(*(volatile unsigned char *)0xffffec)
...
//// DMAC
#define MAR0AR (*(volatile unsigned int *) 0xffff20)
...
#define MAR0BR (*(volatile unsigned int *) 0xffff28)
#define IOAR0B (*(volatile unsigned char *)0xffff2e)
#define ETCR0B (*(volatile unsigned short *)0xffff2c)
#define DTCR0B (*(volatile unsigned char *)0xffff2f)

#define MAR1AR (*(volatile unsigned int *) 0xffff30)
#define IOAR1A (*(volatile unsigned char *)0xffff36)
#define ETCR1A (*(volatile unsigned short *)0xffff34)
#define DTCR1A (*(volatile unsigned char *)0xffff37)

#define MAR1BR (*(volatile unsigned int *) 0xffff38)
#define IOAR1B (*(volatile unsigned char *)0xffff3e)
#define ETCR1B (*(volatile unsigned short *)0xffff3c)
...
#define TCNT_WR (*(volatile unsigned short *)0xffffa8)
#define TCSR_WR (*(volatile unsigned short *)0xffffa8)
#define TCNT_RD (*(volatile unsigned char *)0xffffa8)
#define TCSR_RD (*(volatile unsigned char *)0xffffa9)
...
#define TCNT0 (*(volatile unsigned short *)0xffff68)
...
#define TCNT2 	(*(volatile unsigned short *)0xffff7c)
...
#define TCSR 	(*(volatile unsigned short *)0xffffa8)
